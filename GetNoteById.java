...
public class GetStudentById extends HttpServlet {
    ...
    static final String DB_URL = "jdbc:mysql://106.13.15.42/linux_exam";
    static final String USER = "root";
    static final String PASS = "Kwxy2019!!";
    static final String SQL_QURERY_STUDENT_BY_ID = "SELECT id, name FROM t_notepad WHERE id=?";
